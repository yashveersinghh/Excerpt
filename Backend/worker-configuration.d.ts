/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 5a5f3bc5868a2aa6063da67df219809b)
...
declare namespace Cloudflare {
	...
	interface Env {
		JWT_SECRET: "absabsabsabs";
		GEMINI_API_KEY: "AIzaSyAIuhTs52ux6OQakfXY64WIpNI6ljnXLHc";
		DATABASE_URL: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "JWT_SECRET" | "GEMINI_API_KEY" | "DATABASE_URL">> {}
}

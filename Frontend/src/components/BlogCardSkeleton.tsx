...
export const BlogCardSkeleton: React.FC = () => {
  return (
    <SkeletonTheme baseColor="#eaeaea" highlightColor="#f5f5f5">
      <div className="flex flex-row items-start md:items-center justify-between py-4 mx-4 md:mx-60 border-b border-gray-200 mt-5">
        ...
        <div className="flex shrink-0 mt-10 ml-4">
          <Skeleton width={140} height={100} className="rounded" />
        </div>
      </div>
    </SkeletonTheme>
  )

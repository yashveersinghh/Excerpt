...
export const BlogCard = (props: BlogCardProps) => {
    return (
        <div className="mx-4 md:mx-60 mt-5 mb-5">
            <Link to={`/blog/${props.id}`} className="block cursor-pointer">
                <div className="group flex flex-col md:flex-row items-start md:items-center justify-between gap-5 py-5 rounded-3xl border border-transparent bg-white/80 px-2 shadow-[0_8px_30px_rgba(15,23,42,0.06)] transition-all duration-300 hover:-translate-y-1 hover:border-amber-100 hover:shadow-[0_18px_45px_rgba(15,23,42,0.12)]">
